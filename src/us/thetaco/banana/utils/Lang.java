...
public enum Lang {
	...
	BAN_IP_INCORRECT_ARGS("ban-ip-incorrect-args", "&cInvalid Arguments{NEWLINE}&cUsage: /banip <player/ip> [messsage]"),
	...
	MUTE_BROADCAST("mute-broadcast", "&e{PLAYER} &3has been muted by &e{EXECUTOR}&3. &fReason: &e{MESSAGE}"),
	...
	NO_STAFF("no-staff", "&bThere have been no staff members added"),
